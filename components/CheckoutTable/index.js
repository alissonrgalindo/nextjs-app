import style from "./CheckoutTable.module.scss";
      ...
      {cart.length === 0 ? (<h1>Your Cart is Empty!</h1>) : (<>
        <form onSubmit={submitOrder}>
          <div className={style.header}>
            <div>
              <label className={`${style.label} font-medium`}>Product</label>
            </div>
            <div className="center">
              <label className={`${style.label} font-medium`}>Price</label>
            </div>
            <div className="center">
              <label className={`${style.label} font-medium`}>Quantity</label>
            </div>
            <div className="right">
              <label className={`${style.label} font-medium`}>Cost</label>
            </div>
          </div>
              ...
              <div className={style.body__line}>
                ...
                <div className={style.quantity}>
                  ...
                  <div className={style.count}>
                    <button onClick={() => dispatch(decrementQuantity(item.sku))}>
                    ...
                    <input 
                      ...
                      />
                    <button onClick={() => dispatch(incrementQuantity(item.sku))}>
                ...
                <div className={style.action}>
                  <label className={`${style.label} font-medium`}>Remove</label>
                  <div>
                    <motion.button
